									...
									<form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="post-image">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <img style="width:300px;" src="" class="post_img_load" alt=""><br><br>
                                        ...
                                        <div class="post-gallery">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <input style="display:none;" type="file" name="post_gall[]" id="post_img_select_g" multiple>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="post-audio">
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Post Adio link</label>
                                                <div class="col-lg-9">
