                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
							...
							<a class="btn btn-sm btn-primary" data-toggle="modal" href="#add_category_modal">Add category</a>
							<br>
							<br>
							<div class="card">
												...
												@foreach ($all_data as $data )
													...
													<tr>
														...
														<td>
															...
															<form action="{{route('category.destroy', $data-> id)}}" class="d-inline" method="POST">
																 @csrf
																 @method('DELETE')
